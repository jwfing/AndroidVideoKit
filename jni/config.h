...
#define FFMPEG_CONFIGURATION "--arch=arm --cpu=cortex-a8 --target-os=linux --enable-runtime-cpudetect --prefix=/data/data/info.guardianproject.ffmpeg/app_opt --enable-pic --disable-shared --enable-static --cross-prefix=/Users/junwenfeng/Software/android-ndk-r8e/toolchains/arm-linux-androideabi-4.6/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --sysroot=/Users/junwenfeng/Software/android-ndk-r8e/platforms/android-3/arch-arm --extra-cflags='-I../x264 -I../freetype2/include -mfloat-abi=softfp -mfpu=neon' --extra-ldflags='-L. -L../x264' --enable-version3 --enable-gpl --disable-doc --enable-yasm --enable-decoders --enable-encoders --enable-muxers --enable-demuxers --enable-parsers --enable-protocols --enable-filters --enable-avresample --disable-libfreetype --disable-indevs --enable-indev=lavfi --disable-outdevs --enable-hwaccels --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-network --enable-libx264 --enable-zlib"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define FFMPEG_DATADIR "/data/data/info.guardianproject.ffmpeg/app_opt/share/ffmpeg"
#define AVCONV_DATADIR "/data/data/info.guardianproject.ffmpeg/app_opt/share/ffmpeg"
#define CC_TYPE "gcc"
...
#define CONFIG_AREDACT_FILTER 1
