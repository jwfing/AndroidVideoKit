...
#define FFMPEG_CONFIGURATION "--prefix=./ffmpeg_build --target-os=linux --arch=arm --enable-gpl --enable-cross-compile --cross-prefix=arm-linux-androideabi- --enable-static --disable-symver --disable-doc --disable-ffplay --disable-ffprobe --disable-ffserver --enable-avdevice --enable-avfilter --enable-encoders --enable-encoder=h264 --enable-libx264 --disable-filters --disable-devices --disable-everything --enable-ffmpeg --enable-protocols --enable-parsers --enable-demuxers --enable-muxers --enable-decoders --enable-bsfs --enable-network --enable-swscale --enable-asm --enable-version3 --extra-cflags='-O3 -Wall -mthumb -pipe -fpic -fasm -finline-limit=300 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -fmodulo-sched -fmodulo-sched-allow-regmoves -Wno-psabi -Wa,--noexecstack -D__ARM_ARCH_5__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5TE__ -DANDROID -DNDEBUG -march=armv7-a -mfloat-abi=softfp -mvectorize-with-neon-quad' --extra-ldflags='-Wl,--fix-cortex-a8'"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define FFMPEG_DATADIR "./ffmpeg_build/share/ffmpeg"
#define AVCONV_DATADIR "./ffmpeg_build/share/ffmpeg"
